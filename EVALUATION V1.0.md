...
### 2. Code Coverage: class 100%(1/1) method 100%(1/1) Line 100% (1/1)  
## Manual Test suites
### 1. Generated 4 manual Test suites for the Model Solution
### 2. Code Coverage class 100%(1/1) method 100%(1/1) Line 100% (1/1)
## Pit Test Coverage 
### 1. For the prototype model 20 automated test suites: Coverage class 100%(1/1) method 100%(1/1) Line 100% (1/1)
...
model solution and the difference are saved as not minimized test cases. In total there are 20 different Integer pairs. 
E.g 13, 15... Which these pairs were check for all possible mutants. 5 buggy version * 20 pairs, hence total 100 
test cases "mutants". So now, the prototype model has generated 100 test case and 20 minimized JUnit test suites. 
The final results:

The score is 100%, the experimental results indicates that generated mutants were all killed by its own test suites. 

**Conclusion, The prototype model is performing faster than EvoSuite by generating Test suites for the model solution.
Also, quicker than the PIT Test**
***   
#### Model Solution
...
3 test suites are generated by the EvoSuite and 4 test suties are the Manual test suites.
***
